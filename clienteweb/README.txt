...
a persistence unit "clientewebPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "clienteweb\pom.xml":
...
artifact ("clienteweb.war") is already built. You can build
